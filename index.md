...
| [Create Command](pages/create-command.md)     | &nbsp;&nbsp;&nbsp;&nbsp;/personal/command/create    | Form interface for creating new service definitions with parameter configuration and validation.                        | Template builder, parameter editor, preview functionality   |
| [Edit Command](pages/create-command.md)       | &nbsp;&nbsp;&nbsp;&nbsp;/personal/command/edit/[id] | Editing interface for existing services, allowing modification of templates and parameters.                             | Template editing, parameter configuration, usage statistics |
